...
import tente1 from '../assets/products/tentes/tente-camping-trigano-bilbao-2-places1.jpg'
    ...
    const items= [
      ...
      {id: 4, title: 'table camping',img:'https://contents.mediadecathlon.com/p1757596/k$5f6afde636ebc761b055f38fb88e1db0/table-de-camping-pliante-4-tabourets-4-a-6-personnes.jpg?&f=800x800'},
      {id: 5, title: 'chaise camping',img:'https://contents.mediadecathlon.com/p1749361/k$96ca9266b4a34d7c1099b146f89eb230/fauteuil-pliable-pour-le-camping-basic.jpg?&f=452x452'},
    ]
